...
Our objective is to create distributed state-space realizations of factored controller transfer function matrices. We illustrate these results with the [System Level Synthesis (SLS) factorization](https://arxiv.org/pdf/1610.04815).
...
The script `/demos/model_match_demo.mlx` illustrates how to perform a "model match" to an unconstrained optimization problem which Matlab can solve to synthesize a structured controller realization. We use the system of three river dams presented in [Rantzer, 2019](https://arxiv.org/pdf/1812.07748) as an example.
